        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                ...
                <ul style="list-style-type: none; padding: 0; margin: 0;">
                    <li>✔️ <strong>Sistem pemesanan otomatis</strong></li>
                    <li>✔️ <strong>Dukungan pembayaran lokal & internasional</strong></li>
                    <li>✔️ <strong>Langsung terhubung dengan gate stadion</strong></li>
            </ul>
            </div>
        </div>
    </div>
